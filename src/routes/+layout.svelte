...
<!-- ========== HEADER ========== -->
<header
	class="sticky inset-x-0 top-0 z-[48] flex w-full flex-wrap border-b bg-white py-2.5 text-sm dark:border-gray-700 dark:bg-gray-800 sm:flex-nowrap sm:justify-start sm:py-4 lg:pl-64"
>
	<nav class="mx-auto flex w-full basis-full items-center px-4 sm:px-6 md:px-8" aria-label="Global">
		...
		<div
			class="ml-auto flex w-full items-center justify-end sm:order-3 sm:justify-between sm:gap-x-3"
		>
			<div class="sm:hidden">
				<button
					type="button"
			...
			<div class="hidden sm:block">
				...
				<div class="relative">
					...
					<input
						...
						id="icon"
						name="icon"
						class="block w-full rounded-md border-gray-200 px-4 py-2 pl-11 text-sm shadow-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
						placeholder="Search"
					/>
				</div>
			</div>
			...
			<div class="flex flex-row items-center justify-end gap-2">
				...
				<div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
					...
					<div
						class="hs-dropdown-menu duration hidden min-w-[15rem] rounded-lg bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:border dark:border-gray-700 dark:bg-gray-800"
...
>
	<div class="flex items-center py-4">
		...
		>
			...
			<svg class="h-5 w-5" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
				<path
					fill-rule="evenodd"
		...
		<ol class="ml-3 flex min-w-0 items-center whitespace-nowrap" aria-label="Breadcrumb">
			<li class="flex items-center text-sm text-gray-800 dark:text-gray-400">
				Application Layout
				<svg
					class="mx-3 h-2.5 w-2.5 flex-shrink-0 overflow-visible text-gray-400 dark:text-gray-600"
					width="16"
					height="16"
					viewBox="0 0 16 16"
					fill="none"
			...
			<li
				class="truncate text-sm font-semibold text-gray-800 dark:text-gray-400"
				aria-current="page"
			>
				Dashboard
			</li>
...
>
	...
	<nav class="hs-accordion-group flex w-full flex-col flex-wrap p-6" data-hs-accordion-always-open>
		<ul class="space-y-1.5">
			<li>
				<a
					class="flex items-center gap-x-3.5 rounded-md bg-gray-100 px-2.5 py-2 text-sm text-slate-700 hover:bg-gray-100 dark:bg-gray-900 dark:text-white"
					href="javascript:;"
				>
					<svg
						class="h-3.5 w-3.5"
			...
			<li class="hs-accordion" id="users-accordion">
				<a
					class="hs-accordion-toggle flex items-center gap-x-3.5 rounded-md px-2.5 py-2 text-sm text-slate-700 hover:bg-gray-100 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent dark:bg-gray-800 dark:text-slate-400 dark:hover:bg-gray-900 dark:hover:text-slate-300 dark:hs-accordion-active:text-white"
					href="javascript:;"
				>
					<svg
						class="h-3.5 w-3.5"
					...
					<svg
						class="ml-auto hidden h-3 w-3 text-gray-600 group-hover:text-gray-500 hs-accordion-active:block dark:text-gray-400"
						width="16"
						height="16"
						viewBox="0 0 16 16"
						fill="none"
					...
					<svg
						class="ml-auto block h-3 w-3 text-gray-600 group-hover:text-gray-500 hs-accordion-active:hidden dark:text-gray-400"
						width="16"
						height="16"
						viewBox="0 0 16 16"
						fill="none"
					...
					<ul class="hs-accordion-group pl-3 pt-2" data-hs-accordion-always-open>
						<li class="hs-accordion" id="users-accordion-sub-1">
							...
							>
								<ul class="pl-2 pt-2">
									<li>
										<a
											class="flex items-center gap-x-3.5 rounded-md px-2.5 py-2 text-sm text-slate-700 hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
											href="javascript:;"
										>
											Link 1
										</a>
						...
						<li class="hs-accordion" id="users-accordion-sub-2">
							...
							<div
								...
								class="hs-accordion-content hidden w-full overflow-hidden pl-2 transition-[height] duration-300"
							>
								<ul class="pl-2 pt-2">
									<li>
										<a
			...
			<li>
				<a
					class="flex items-center gap-x-3.5 rounded-md px-2.5 py-2 text-sm text-slate-700 hover:bg-gray-100 dark:text-slate-400 dark:hover:bg-gray-900 dark:hover:text-slate-300"
					href="javascript:;"
				>
					<svg
						class="h-3.5 w-3.5"
...
<div class="w-full px-4 pt-10 sm:px-6 md:px-8 lg:pl-72">
	...
	<header>
		...
		<div class="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
			<a
				class="inline-flex w-full items-center justify-center gap-x-3 rounded-md border border-transparent bg-blue-600 px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-800 sm:w-auto"
